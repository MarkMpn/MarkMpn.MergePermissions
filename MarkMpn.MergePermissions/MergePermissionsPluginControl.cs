...
{
    public partial class MergePermissionsPluginControl : PluginControlBase, IGitHubPlugin, IAboutPlugin, IHelpPlugin, IPayPalPlugin
    {
        ...
        string IGitHubPlugin.RepositoryName => "MarkMpn.MergePermissions";

        string IGitHubPlugin.UserName => "MarkMpn";

        string IHelpPlugin.HelpUrl => "https://markcarrington.dev/merge-permissions/";
